...
def main():
    ...
    P_VALUES = [round(p, 2) for p in np.arange(0.00, 1.01, 0.05)]
    SHOTS = 1000000 
    ...
    for n in N_VALUES:
        ...
        print(f"  n={n:2} 完了. (例: p=0.05時 Sim={all_results[n]['sim'][0][1]:.4f} / Theory={all_results[n]['theory'][0][1]:.4f})")
    ...
    # n ごとに色を区別するためのカラーマップ (n=1から10まで10色)
